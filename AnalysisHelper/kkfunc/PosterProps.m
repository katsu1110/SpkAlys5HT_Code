function PosterProps(ax, xlim_, ylim_, xtick_, ytick_, varargin)
...
set(ax, 'xlim', [xlim_(1) xlim_(end)], ...
    ...
    'XTick', xtick_, 'YTick', ytick_, ...
    'TickDir', 'out', ...
    'LineWidth', 0.5, ...
    'XTickLabel', cellfun(@num2str, num2cell(xtick_'),'UniformOutput', 0), ...
    'YTickLabel', cellfun(@num2str, num2cell(ytick_'),'UniformOutput', 0), ...
    'LineWidth', 0.5, ...
    'FontSize', fsz, ...
    'XColor', 'k', 'YColor', 'k');
