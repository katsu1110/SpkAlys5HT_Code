function [spkiso, h] = spikeisolation_time(exinfo, drug, fig, saveoption, varargin)
...
X00 = [spkiso.c0.energy, spkiso.c0.norm_pca(:,1:2), spkiso.c0.time];
...
X11 = [spkiso.c1.energy, spkiso.c1.norm_pca(:,1:2), spkiso.c1.time];
