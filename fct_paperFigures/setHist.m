...
text(ax, arrowpos(1)-(ax.XLim(2)*0.01), ax.YTick+(ax.YTick*0.4), sprintf('%1.2f',arrowpos(1)), ...
    'Color', uni_r, 'FontSize', txtsz, 'Rotation', rot, 'HorizontalAlignment', 'center');
text(ax, arrowpos(2)+(ax.XLim(2)*0.01), ax.YTick+(ax.YTick*0.4), sprintf('%1.2f',arrowpos(2)),...
